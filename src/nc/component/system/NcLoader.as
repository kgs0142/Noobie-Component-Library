package nc.component.system 
{
     ...
     * @author Husky
     */
    public class NcLoader extends NcBaseComponent
    {
        ...
        public function NcLoader() 
        {
            m_sPrefix = "../";
            m_zipEmbedFile = null;
            m_fnComplete = NcDefine.FN_EMPTY;
            ...
            //Get DebuggerComponent, and use NC_LOG
            NC_LOG("Create Loader Component");
        }
        ...
        private function LoadingComplete() : void
        {
            ...
            NC_LOG("Load all asset complete");
            
            m_fnComplete();
            
            NcEntityManager.Get().dispatchEvent(new Event(NcLoader.LOAD_COMPLETE));
        }
        //------------------------------------------------------------------------
        ...
        {
            m_fnComplete = (fnComplete == null) ? NcDefine.FN_EMPTY : fnComplete;
...
internal class CLoadingData
{
    ...
    private function MakeAssetType(sExtension:String) : String
    {
        switch (sExtension.toLowerCase())
        {
            ...
            case "png":
            case "bmp":
                return NcLoader.IMG_TYPE;
                
            case "wav":
            case "mp3":
                return NcLoader.SND_TYPE;
            
            case "swf":
                return NcLoader.SWF_TYPE;
